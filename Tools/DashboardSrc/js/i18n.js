    ...
    const i18n = {
      en: {
        ...
        pending: 'Pending', active: 'Active', completed: 'Done', not_performed: 'Not performed',
        ...
        logStarted: 'Started', logCompleted: 'Completed',
      ...
      pt: {
        ...
        pending: 'Pendente', active: 'Ativa', completed: 'Concluída', not_performed: 'Não realizada',
        // log (the typed glyph comes from the gutter column, not from the text)
        ...
        logStarted: 'Iniciada', logCompleted: 'Concluída',
    ...
    const labels = {
      ...
      // TASK_OMITTED e TASK_FAILED são códigos aposentados, mantidos traduzidos porque os
      // logs já coletados os contêm. O código vigente é TASK_NOT_PERFORMED.
      violation: {
        en: {
          ...
          TASK_NOT_PERFORMED: 'Task not performed',
          TASK_OMITTED: 'Task omitted', TASK_FAILED: 'Task not completed',
          GATE_FAILED: 'Inspection not approved',
        ...
        pt: {
          ...
          TASK_OMITTED: 'Tarefa omitida', TASK_FAILED: 'Tarefa não concluída',
    ...
    export function violationMessage(code, message) {
      ...
      const portugueseMessages = {
        ...
        TASK_FAILED: /^Tarefa não concluída/,
