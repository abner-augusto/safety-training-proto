...
namespace SafetyProto.Runtime.Tools.Drill
{
    public class DrillUse : MonoBehaviour, IHandGrabUseDelegate
    {
        ...
        private void OnValidate()
        {
            ...
            if (axisCount > 1)
            {
                UnityEngine.Debug.LogWarning("DrillUse: Use a single SnapAxis for trigger rotation to avoid compounded axes.", this);
            }
        }
#endif
        ...
        private void UpdateTriggerRotation(float progress)
        {
            ...
            _trigger.localRotation = _triggerInitialLocalRot * axisRotation;
        }
