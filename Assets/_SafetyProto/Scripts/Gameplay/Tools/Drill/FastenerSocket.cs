...
public class FastenerSocket : MonoBehaviour
{
    ...
    {
        drillDir = drillDir.normalized; // Normalize input to avoid caller variance.
        ...
        pressure = 1f - Mathf.Clamp01(axialAbs / required); // Use axial depth for pressure.
    ...
    private void SnapHeadVisuals()
    {
        ...
        _head.localRotation = _headInitialLocalRotation; // Keep final rotation stable.
    }
